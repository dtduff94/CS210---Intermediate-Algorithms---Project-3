...
public class Autocomplete {
	...
	int first = BinarySearchDeluxe.firstIndexOf(terms, match, Term.byPrefixOrder(prefix.length()));
	int last = BinarySearchDeluxe.lastIndexOf(terms, match, Term.byPrefixOrder(prefix.length()));
